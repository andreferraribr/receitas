...
# selecionar o RGF (tipo == "RGF") do terceiro quadrimenestre (periodo ==1) do poder executivo (poder == "E")
 rgf_url<-extratos_relatorios%>%
  filter(  tipo == "RGF", poder =="E", periodo == 2)
...
# selecionar o RREO (tipo == "RREO") do primeiro bimenestre (periodo == 2) do poder executivo (poder == "E")
rreo_url<-extratos_relatorios%>%
 filter(  tipo == "RREO", poder =="E", periodo == 2)
...
df_icms_bimestre<-df_icms %>%
                  ...
                  filter(month(mes_ano) %in% c(4), exercicio %in% c(2020,2019)) %>% 
